"""
Módulo de configuración centralizada para logging.

Este módulo proporciona una configuración profesional de logging para todo el proyecto
de pipeline de detección de Concept Drift. Utiliza la librería estándar `logging` de Python.

Características:
- Doble salida: Archivo (.log) con todos los niveles (DEBUG+) y consola (INFO+)
- Formato consistente con timestamp, nivel, módulo y mensaje
- Configuración centralizada reutilizable en todos los módulos
"""
