...
```bash
git clone https://github.com/Gaboguevaram/multiperspective-drift-detection.git
cd multiperspective-drift-detection
```
...
INFO  - Guardando el modelo descubierto como ./data/06_models/ControlFlow_PetriNet_InductiveMiner_20240515_103012_123456.png
