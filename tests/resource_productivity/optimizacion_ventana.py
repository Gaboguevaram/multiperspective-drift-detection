...
def objective(trial):
    ...
    with open("./tests/resource_productivity/params_template.yml", "r", encoding="utf-8") as f:
        contenido = f.read()
    ...
    comando = [sys.executable, "-m", "tests.resource_productivity.script_resource_productivity",
