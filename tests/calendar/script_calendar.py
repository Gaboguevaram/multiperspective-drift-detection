...
# Lista de logs
LOGS = [
    "./data/01_raw/calendar/Caso_A/Ac_sudden_caso_a_15000.csv",
    "./data/01_raw/calendar/Caso_A/Ac_sudden_caso_a_17500.csv",
    "./data/01_raw/calendar/Caso_A/Ac_sudden_caso_a_10000.csv",
    "./data/01_raw/calendar/Caso_A/Ac_sudden_caso_a_12500.csv",

    "./data/01_raw/calendar/Caso_B/Rc_sudden_caso_b_15000.csv",
    "./data/01_raw/calendar/Caso_B/Rc_sudden_caso_b_17500.csv",
    "./data/01_raw/calendar/Caso_B/Rc_sudden_caso_b_10000.csv",
    "./data/01_raw/calendar/Caso_B/Rc_sudden_caso_b_12500.csv"
]
...
def main(config_file, logs=None):
    ...
    for log in logs:
        ...
        comando = ["python", "-m", "tests.test_perspectivas", "--log", log, "--perspectiva", "calendar","--file", config_file]
...
if __name__ == "__main__":
    ...
    parser.add_argument('-f', '--file', help='Indica el archivo de configuración .yml a usar', type=str, default="./conf/calendar.yml")
