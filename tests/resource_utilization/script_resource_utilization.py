...
# Lista de logs
LOGS = [
    "./data/01_raw/resource_utilization/RU-A/ru_a-5000-single.csv",
]
...
def main(config_file, logs=None):
    ...
    for log in logs:
        ...
        comando = ["python", "-m", "tests.test_perspectivas", "--log", log, "--perspectiva", "resource_utilization", "--file", config_file]
...
if __name__ == "__main__":
    ...
    parser.add_argument('-f', '--file', help='Indica el archivo de configuración .yml a usar', type=str, default="./conf/resource_utilization.yml")
