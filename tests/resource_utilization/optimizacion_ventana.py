...
# RU-A (único caso de utilización: servicio más lento de Marta -> sube su utilización; Carlos control).
LOG_OBJETIVO = "./data/01_raw/resource_utilization/Caso_B/TP_sudden_caso_b_5000.csv"
...
def objective(trial):
    ...
    # La utilización se mide sobre jornadas, así que la escala de la ventana es de días.
    tamano_ventana = trial.suggest_categorical('tamano_ventana', [
        '1 hour', '2 hours', '4 hours', '6 hours', '9 hours', '12 hours', '18 hours', 
    ...
    with open("./tests/resource_profiles/resource_utilization/params_template.yml", "r", encoding="utf-8") as f:
        contenido = f.read()
    ...
    archivo_config = f"./conf/pruebas/resource_utilization_tests_{trial.number}.yml"
    ...
    comando = [sys.executable, "-m", "tests.resource_profiles.resource_utilization.script_resource_utilization",
