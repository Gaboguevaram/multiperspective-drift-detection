...
LOG_OBJETIVO = "./data/01_raw/resource_utilization/RU-A/ru_a-5000-single.csv"
...
def objective(trial):
    ...
    with open("./tests/resource_utilization/params_template.yml", "r", encoding="utf-8") as f:
        contenido = f.read()
    ...
    comando = [sys.executable, "-m", "tests.resource_utilization.script_resource_utilization",
